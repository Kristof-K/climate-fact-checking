...
class CharToCharLSTM(MaskedChartoChar):
    ...
    def __init__(self, text_encoder: CharOneHotEncoder, num_neurons: List[int],
        ...
        for i in range(1, len(num_neurons)):
            encoder_lstms.append(LSTM(num_neurons[i - 1], return_sequences=True))
        encoder_lstms.append(LSTM(num_neurons[-1], return_state=True))    # output hidden states
        ...
        encoder_output, en_state_h, en_state_c = encoder_out
